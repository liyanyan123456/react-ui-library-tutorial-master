...
import useXComponentConfig from '../util/hooks/use-x-component-config';
...
function Welcome(props: WelcomeProps, ref: React.Ref<HTMLDivElement>) {
  console.log('Welcome component is rendering', props);
  const {
  ...
  // ============================ Render ============================
  console.log('Rendering Welcome component', { prefixCls, contextConfig, hashId, cssVarCls });
  return wrapCSSVar(
    <Flex
      ref={ref}
      className={classnames(
